...
const cards: BoardTask[] = [
	...
	{
		id: "DEV-200",
		title: "Cron migration to temporal",
		status: "done",
		agent: "deployer",
		meta: "shipped",
	},
	...
	{ id: "DEV-198", title: "SSO group sync", status: "backlog", agent: "none" },
];
				...
				<div className="grid min-w-0 items-start gap-8 lg:grid-cols-12 lg:gap-12">
					<div className="min-w-0 lg:col-span-4">
						...
						<p className="mt-5 max-w-md text-muted-foreground leading-relaxed">
							Every task is a card. Every card has a status, owner, and trail.
						...
						<ul className="mt-7 space-y-3 text-sm">
							{[
								...
								"Full run history",
								"Real-time sync to Linear and GitHub",
							].map((item) => (
						...
						<div className="max-w-full overflow-hidden border-2 border-foreground bg-card shadow-retro">
							<div className="flex h-11 items-center justify-between border-foreground border-b-2 bg-foreground px-4 text-background">
								<div className="flex items-center gap-2 font-mono text-xs">
									...
									<span className="text-background/55">/ q2-platform</span>
								</div>
...
function BoardCard({ card }: { card: BoardTask }): ReactElement {
	...
	return (
		<div className="cursor-grab border-2 border-foreground bg-card p-2.5 shadow-[2px_2px_0_0_var(--foreground)] transition-all hover:-translate-x-px hover:-translate-y-px">
